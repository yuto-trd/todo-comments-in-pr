...
describe('extractTasks', () => {
  const comments: CommentChunk[] = [
    { startLine: 1, endLine: 1, content: '// TODO: refactor this function', fileName: 'file1.ts' },
    { startLine: 2, endLine: 2, content: '// FIXME: fix this bug', fileName: 'file2.ts' },
    { startLine: 3, endLine: 3, content: '// This is a regular comment', fileName: 'file3.ts' },
    { startLine: 4, endLine: 4, content: '/*\n * TODO: add more tests\n */', fileName: 'file4.ts' }
  ];
